...
def resnet18(pretrained=True, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(
            model_urls['resnet18']), strict=False, map_location=lambda storage, loc: storage.cuda())
    return model
...
def resnet34(pretrained=True, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(
            model_urls['resnet34']), strict=False, map_location=lambda storage, loc: storage.cuda())
    return model
...
def resnet50(pretrained=True, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(
            model_urls['resnet50']), strict=False, map_location=lambda storage, loc: storage.cuda())
    return model
...
def deformable_resnet50(pretrained=True, **kwargs):
    ...
    model = ResNet(Bottleneck, [3, 4, 6, 3],
                   ...
                   **kwargs)
    if pretrained:
        #model.load_state_dict(torch.load('./models/pre-trained-model-synthtext-resnet50'))
        model.load_state_dict(model_zoo.load_url(
...
def resnet101(pretrained=True, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(
            model_urls['resnet101'], map_location=torch.device('cuda')), strict=False)
    return model
...
def resnet152(pretrained=True, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(
            model_urls['resnet152']), strict=False, map_location=lambda storage, loc: storage.cuda())
    return model